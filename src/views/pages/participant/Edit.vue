...
const tempResidenceParticipant = ref(null);
const tempResidenceCities = ref([]);
const tempResidenceDistricts = ref([]);
const tempResidenceVillages = ref([]);
...
onMounted(async () => {
    await participantService
        ...
        .then((result) => (newParticipant.value = result))
        .then(() => (status.value = newParticipant.value.status))
        .then(() => regionService.getProvincies({}).then((result) => (provinces.value = result)))
        .then(async () => {
...
const deleteParticipant = () => {
    try {
        participantService
            .deleteParticipant(newParticipant.value.id)
            .then(() => {
...
const handleSubmits = async () => {
    ...
    try {
        ...
        formData.append('status', newParticipant.value.status);
        formData.append('updated_by', user.value);

        participantService
            .editParticipant(newParticipant.value.id, formData)
            .then((result) => {
                toast.add({ severity: 'success', summary: 'Successful Update Penerima', detail: 'Penerima Updated', life: 3000 });
                loading.value = false;
                newParticipant.value = result;
...
const duplicateResidence = () => {
    ...
    try {
        if (isSelected.value) {
            tempResidenceParticipant.value = Object.assign({}, newParticipant.value);
            tempResidenceCities.value = residence_cities.value;
            tempResidenceDistricts.value = residence_districts.value;
            tempResidenceVillages.value = residence_villages.value;
            ...
            newParticipant.value.residence_address = tempResidenceParticipant.value.residence_address;
            newParticipant.value.residence_rt = tempResidenceParticipant.value.residence_rt;
            newParticipant.value.residence_rw = tempResidenceParticipant.value.residence_rw;
            newParticipant.value.residence_provinsi = tempResidenceParticipant.value.residence_provinsi;
            newParticipant.value.residence_kota = tempResidenceParticipant.value.residence_kota;
            newParticipant.value.residence_kecamatan = tempResidenceParticipant.value.residence_kecamatan;
            newParticipant.value.residence_kelurahan = tempResidenceParticipant.value.residence_kelurahan;
            newParticipant.value.residence_kode_pos = tempResidenceParticipant.value.residence_kode_pos;
            residence_cities.value = tempResidenceCities.value;
            residence_districts.value = tempResidenceDistricts.value;
            residence_villages.value = tempResidenceVillages.value;
        }
    } catch (e) {
        console.error(e);
    }
...
<template>
    ...
    <div class="card">
        <Toolbar class="mb-4">
            ...
            <template v-slot:end>
                <Button label="Delete" class="p-button-danger ml-2" @click="confirmDeleteParticipant" />
                <Button label="Reset" class="p-button-info ml-2" @click="confirmResetParticipant" />
            </template>
        </Toolbar>
        ...
        <form @submit="onSubmit">
            <div class="formgrid grid">
                <div class="field col">
                    <div class="p-fluid">
                        <div class="field">
                            ...
                            <Dropdown class="mr-4 mb-2" v-model="newParticipant.status" :options="statuses" optionValue="code" optionLabel="name" placeholder="Status" @change="handleStatus" />
                        </div>
                        <div class="field">
                        ...
                        <div class="field">
                            ...
                            <InputText id="age1" v-bind="phone" required="true" type="text" placeholder="08*********" v-model="newParticipant.phone" aria-describedby="phone-help" :class="{ 'p-invalid': errors.phone }" />
                ...
                <div class="field col">
                    ...
                    <div class="mb-4">
                        <div v-if="newParticipant.image">
                            <img :src="baseUrl + `/v1/` + newParticipant.image" height="250" alt="Logo" class="result_img mr-2" v-if="!file" />
                            <FileUpload
                                required="true"
                                accept="image/*"
                                customUpload
                    ...
                    <div v-if="newParticipant.image_penerima">
                        <img class="result_img mr-2" :src="baseUrl + `/v1/` + newParticipant.image_penerima" height="250" alt="Logo" v-if="!file_penerima" />
                        <FileUpload
                            required="true"
                            accept="image/*"
                            :maxFileSize="1000000"
                            ...
                            @abort="file_penerima = null"
                            @clear="file_penerima = null"
                ...
                <div class="field col">
                    <div class="p-fluid">
                        ...
                        <div class="field">
                            ...
                            <InputText v-bind="address" id="name1" type="text" required="true" placeholder="Alamat" v-model="newParticipant.address" aria-describedby="address-help" :class="{ 'p-invalid': errors.address }" />
                        ...
                        <div class="grid formgrid mb-4">
                            <div class="col-12 mb-2 lg:col-4 lg:mb-0 field">
                                ...
                                <InputText v-bind="rt" id="email1" type="text" required="true" placeholder="RT" v-model="newParticipant.rt" aria-describedby="rt-help" :class="{ 'p-invalid': errors.rt }" />
                            ...
                            <div class="col-12 mb-2 lg:col-4 lg:mb-0 field">
                                ...
                                <InputText v-bind="rw" id="age1" type="text" required="true" placeholder="RW" v-model="newParticipant.rw" aria-describedby="rw-help" :class="{ 'p-invalid': errors.rw }" />
                        ...
                        <div class="field">
                            ...
                            <!-- <InputText id="name1" type="text" v-model="newParticipant.kecamatan" /> -->
                            <Dropdown
                                v-bind="kecamatan"
                        ...
                        <div class="field">
                            ...
                            <!-- <InputText id="name1" type="text" v-model="newParticipant.kelurahan" /> -->
                            <Dropdown
                                v-bind="kelurahan"
                        ...
                        <div class="field">
                            ...
                            <InputText v-bind="kode_pos" :required="true" id="name1" type="text" placeholder="Kode Pos" v-model="newParticipant.kode_pos" aria-describedby="kode_pos-help" :class="{ 'p-invalid': errors.kode_pos }" />
                            <small id="kode_pos-help" class="p-error">
                                {{ errors.kode_pos }}
                            </small>
                            <!--                        <Dropdown v-model="poscode" :options="poscodes" optionValue="name" optionLabel="name" placeholder="Kode POS" />-->
                        </div>
                    </div>
                </div>
                <div class="field col">
                    <div class="p-fluid">
                        ...
                        <div class="field-checkbox mb-4">
                            <Checkbox v-bind="newParticipant2" id="checkOption2" name="option" :value="newParticipant2" v-model="checkboxValue" @change="duplicateResidence" aria-describedby="option-help" :class="{ 'p-invalid': errors.option }" />
                        ...
                        <div class="field">
                            <label for="name1">Alamat</label>
                            <InputText v-bind="residence_address" id="name1" type="text" placeholder="Alamat" v-model="newParticipant.residence_address" aria-describedby="residence_address-help" :class="{ 'p-invalid': errors.residence_address }" />
                        ...
                        <div class="grid formgrid mb-4">
                            <div class="col-12 mb-2 lg:col-4 lg:mb-0 field">
                                ...
                                <InputText v-bind="residence_rt" id="email1" type="text" placeholder="RT" v-model="newParticipant.residence_rt" aria-describedby="residence_rt-help" :class="{ 'p-invalid': errors.residence_rt }" />
                            ...
                            <div class="col-12 mb-2 lg:col-4 lg:mb-0 field">
                                <label for="age1">RW</label>
                                <InputText v-bind="residence_rw" id="age1" type="text" placeholder="RW" v-model="newParticipant.residence_rw" aria-describedby="residence_rw-help" :class="{ 'p-invalid': errors.residence_rw }" />
                        ...
                        <div class="field">
                            <label for="name1">Provinsi</label>
                            <!-- <InputText id="name1" type="text" v-model="newParticipant.residence_provinsi" /> -->
                            <Dropdown
                        ...
                        <div class="field">
                            <label for="name1">Kota</label>
                            <!-- <InputText id="name1" type="text" v-model="newParticipant.residence_kota" /> -->
                            <Dropdown
                        ...
                        <div class="field">
                            <label for="name1">Kecamatan</label>
                            <!-- <InputText id="name1" type="text" v-model="newParticipant.residence_kecamatan" /> -->
                            <Dropdown
                        ...
                        <div class="field">
                            <label for="name1">Kelurahan</label>
                            <!-- <InputText id="name1" type="text" v-model="newParticipant.residence_kelurahan" /> -->
                            <Dropdown
        ...
        <Dialog header="Confirmation" v-model:visible="displayConfirmationSubmit" :style="{ width: '550px' }" :modal="true">
            <div class="flex align-items-center justify-content-center">
                <h5 class="text-center">Apakah anda ingin input data peserta <b>DIPERBARUI</b>?</h5>
            </div>
            <template #footer>
                <Button label="No" icon="pi pi-times" :loading="loading" @click="closeConfirmation" class="p-button-danger" />
                <Button label="Yes" icon="pi pi-check" :loading="loading" @click="handleSubmits" class="p-button-success" />
        ...
        <Dialog v-model:visible="deleteDialog" :style="{ width: '450px' }" header="Confirm" :modal="true">
            <div class="flex align-items-center justify-content-center">
                ...
                <span v-if="newParticipant"
                    >Are you sure you want to delete <b>{{ newParticipant.name }} {{ newParticipant.nik }}</b
                    >?</span
                >
            </div>
            <template #footer>
        ...
        <Dialog v-model:visible="resetDialog" :style="{ width: '450px' }" header="Confirm" :modal="true">
            <div class="flex align-items-center justify-content-center">
                <i class="pi pi-exclamation-triangle mr-3" style="font-size: 2rem" />
                <span v-if="newParticipant"
                    >Are you sure you want to reset <b>{{ newParticipant.name }} {{ newParticipant.nik }}</b
                    >?</span
                >
            </div>
            <template #footer>
